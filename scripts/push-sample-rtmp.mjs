...
// material, so it cannot be redistributed. Bring your own esports clip:
...
broadcast material, so it cannot be redistributed. Bring your own esports clip:
...
Only stream footage that you are authorized to use.`;
}
...
function usage() {
  console.log(`Push a local esports clip to Agora Media Gateway as a live RTMP source.
